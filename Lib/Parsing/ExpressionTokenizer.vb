...
Friend Class ExpressionTokenizer
    ...
    Private Sub CreatePatterns()
        ...
        pattern = New TokenPattern(CInt(ExpressionConstants.AND), "AND", TokenPattern.PatternType.STRING, "&&")
        AddPattern(pattern)

        pattern = New TokenPattern(CInt(ExpressionConstants.OR), "OR", TokenPattern.PatternType.STRING, "OR")
        AddPattern(pattern)

        pattern = New TokenPattern(CInt(ExpressionConstants.OR), "OR", TokenPattern.PatternType.STRING, "||")
        AddPattern(pattern)
